requirejs.config({
    ...
    paths: {
        ...
        datetimepicker: 'plugins/datetimepicker/js/bootstrap-datetimepicker.min',
        slimscroll: 'plugins/slimScroll/jquery.slimscroll.min',
        treeTable: 'plugins/treetable/jquery.treetable.my',
        jqueryEasy_ui: 'plugins/easyui/js/jquery.easyui.min',
    ...
    shim: {
        ...
        'ztree_all':{ deps:['jquery', 'plugins/ztree/js/jquery.ztree.all.min'] },
...
define(function(require, exports, module){
    ...
    require(['select2_all'],function() {
        ...
        $(".select2").select2({
            ...
            allowClear:true,
            //tags: true,  //可以手动添加数据
            width: "194px" //设置宽度，也可以在ui中加入data-width属性进行个性化设置
        });
